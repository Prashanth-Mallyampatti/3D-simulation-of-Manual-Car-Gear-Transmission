...
static void SOLID_CLOSED_CYLINDER (GLUquadric* quad, GLdouble base, GLdouble top, GLdouble height, GLint slices, GLint stacks)
{
...
static void draw_name()
{
	...
	DrawTextXY(-11.0, 3.0, 0.0, 0.01, "RNS INSTITUTE OF TECHNOLOGY");

	glColor3f(1.0, 0.6, 0.0);
	DrawTextXY(-10.0, -1.0, 0.0, 0.008, "Submitted by:");
	DrawTextXY(-8.0, -2.0, 0.0, 0.005, "PRASHANTH M (1RN14CS068)");
	DrawTextXY(-8.0, -3.0, 0.0, 0.005, "PRAVEEN KUMAR (1RN14CS072)");
...
void draw_name1()
{
	...
	DrawTextXY(-12.0, 12.0, 0.0, 0.015, "Manual Gear transmission");
	displayText(-20.0, 4.0, 0.0,0.0,1.0, "Engine shaft");
	displayText(-4.0, -9.0, 0.0, 0.0, 1.0, "Intermediate shaft");
	displayText(14.0, 4.0, 0.0, 0.0, 1.0, "Output shaft");
	displayText(15.0, -13.0,0.9,0.9,0.9, "*right click to select gear");
	glEnable(GL_LIGHTING);
	glEnable(GL_LIGHT0);
}
...
void display(void)
{
	glClearColor(0.94, 0.94, 1.0, 0.5);
	draw();
}
